...
저는 **제조 현장을 이해하는 소프트웨어/AI 엔지니어**를 목표로 하고 있습니다.  
정밀기계, 설비 제어, 전자공학, 소프트웨어를 거쳐 현재는 **제조 설비 데이터 기반 고장진단·예지보전(PHM)** 과 **스마트팩토리 AI**에 집중하고 있습니다.

단순히 모델을 만드는 것보다, 실제 현장에서 발생하는 센서 노이즈, 설비 상태 변화, 공정 조건 차이, 희귀 고장 데이터 부족 같은 문제를 이해하고 해결하는 AI를 만들고 싶습니다.
...
| 2021.07 - 2024.02 | 학사 학위 취득 | 군 복무와 병행해 학위 취득, 생산/경영/시스템 관점 확장 |
| 2023.06 - 2024.03 | 설비 제어 및 자동화 | PLC, 센서 I/O, 인터락, 설비 에러 로그 기반 문제 분석 |
| 2024.03 - 2025.03 | 전자공학 수학 | 회로, 신호, 반도체 시스템 관점 학습 |
| 2025.03 - 2027.02 | 소프트웨어융합공학 | AI, 데이터, 백엔드, 시스템 구현 역량 강화 |
...
회사명은 공개하지 않지만, 정밀부품 제조와 설비 제어 현장에서 근무하며 설비 상태, 센서 신호, 에러 로그, 공정 품질 문제가 어떻게 연결되는지 경험했습니다.
