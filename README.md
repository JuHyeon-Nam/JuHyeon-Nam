...
정밀기계, 설비 제어, 전자공학, 소프트웨어를 거쳐 현재는 **제조 설비 데이터 기반 고장진단·예지보전(PHM)** 과 **스마트팩토리 AI**에 집중하고 있습니다.
...
| 2021.05 - 2022.11 | 군 복무 | 방공 레이더 운용, 노이즈 속 실제 신호 판단, 모범용사상 |
| 2021.07 - 2024.02 | 학점은행제 학사 학위 취득 | 군 복무와 병행해 학위 취득, 생산/경영/시스템 관점 확장 |
| 2023.06 - 2024.03 | 설비 제어 및 자동화 | PLC, 센서 I/O, 인터락, 설비 에러 로그 기반 문제 분석 |
| 2024.03 - 2025.03 | 전자공학 전공 과정 수학 | 회로, 신호, 반도체 시스템 관점 학습 |
