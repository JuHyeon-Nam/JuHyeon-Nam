...
**기계를 직접 다루는 현장 경험을 바탕으로 제조 AI까지 확장해 온 흐름**입니다.
...
| 2026.07–현재 | KITECH 현장실습 | 로봇자동화·가공데이터 |
...
| 구분 | 내용 |
|---|---|
| 현재 | 인하대학교 소프트웨어융합공학과 · 2027년 2월 졸업 예정 · GPA 3.91 / 4.5 |
| 연구 분야 | 제조 AI, PHM, 스마트팩토리, 센서 데이터, 디지털 트윈 |
| 현장 기반 | 정밀부품 제조, PLC·센서 I/O, 인터락, 설비 에러 로그 분석 |
| 목표 | 제조 설비 상태진단과 공정 지능화를 연결하는 엔지니어 |
...
제 강점은 실제 제조 현장에서 설비 상태, 센서 신호, 에러 로그, 공정 품질의 연결을 경험한 점입니다.

| 기간 | 구분 | 경험한 내용 |
|---|---|---|
| 2020.01–2021.01 | 정밀부품 제조 | 금형, 프레스·사출 설비, 비전검사, 품질 편차 관찰 |
| 2023.06–2024.03 | 설비 제어·자동화 | PLC·센서 I/O·인터락, 설비 에러 로그 분석 |
| 2026.07–현재 | KITECH 현장실습 | 스마트 제조, 로봇자동화, 가공 데이터 연구 환경 |

### 한국생산기술연구원 현장실습

**2026.07–현재**

스마트 제조와 로봇 자동화 연구 환경에서 가공 공정 데이터를 AI/PHM 연구 주제로 연결하는 방향을 구체화하고 있습니다.

### 설비 제어 및 자동화 경험

**2023.06–2024.03**

제조 설비의 PLC, 센서 I/O, 인터락, 통신 상태, 에러 로그를 다루며 설비 정지 원인을 분석했습니다.

- 설비 에러 로그와 센서 입력 상태를 비교해 이상 원인 분석
- 인터락 조건, 신호 지연, 장비 정지 시퀀스 확인
- 센서 신호 집중에 따른 제어 지연과 설비 정지 문제 분석

### 정밀부품 생산기술 경험

**2020.01–2021.01**

정밀부품 제조 현장에서 금형, 프레스·사출 설비, 공정 조건, 검사 공정을 경험했습니다.

- 공정 조건의 작은 변화가 불량과 품질 편차로 이어지는 현장 경험
- 비전검사와 설비 상태 확인을 통한 품질 문제 관찰
...
| 설비 / 안전 | 승강기기능사 |
| 비즈니스 / 커뮤니케이션 | 텔레마케팅관리사, 매경TEST 우수 |
